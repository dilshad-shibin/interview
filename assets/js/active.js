...
(function($) {
    ...
    // :: 0.0 Google SLIDER ACTIVE CODE
    // $('.google-slider.owl-carousel').owlCarousel({
    //     loop: true,
    //     margin: 30,
    //     nav: false,
    //     dots: true,
    ...
    $('.testi-slider.owl-carousel').owlCarousel({
     ...
     // :: 0.0 Goolgle SLIDER ACTIVE CODE
     $('.google-slider.owl-carousel').owlCarousel({
        loop: true,
        margin: 0,
        nav: false,
    ...
    // :: 0.0 testi SLIDER ACTIVE CODE
    $('.gal-slider.owl-carousel').owlCarousel({
        loop: true,
        margin: 30,
        nav: false,
        dots: true,
    ...
    // :: 0.0 Aminities SLIDER ACTIVE CODE
    $('.ameni-slider.owl-carousel').owlCarousel({
        loop: true,
        margin: 30,
        nav: false,
        dots: true,
